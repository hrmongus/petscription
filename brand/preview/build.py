...
<link href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700&family=Archivo+Narrow:wght@400;600&family=Courier+Prime:wght@400;700&family=Instrument+Serif:ital@0;1&display=swap" rel="stylesheet">
<style>
 body{{background:#F4EBDC;color:#17150F;margin:0;padding:36px;display:grid;grid-template-columns:repeat(3,1fr);gap:28px;font-family:'Archivo Narrow',sans-serif}}
